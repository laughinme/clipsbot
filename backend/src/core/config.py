...
class Settings(BaseSettings):
    ...
    WORKER_RECONNECT_DELAY_SEC: int = 5
    WORKER_CONSUMER_HEALTHCHECK_SEC: int = 30
    ...
    EMBEDDING_MEDIA_CONVERSION_TIMEOUT_SEC: int = 120
    ...
    ARCHIVE_SYNC_STARTUP_RECOVERY_OLDER_THAN_MINUTES: int = 2
    ARCHIVE_SYNC_STALE_PROCESSING_MINUTES: int = 2
    ARCHIVE_SYNC_PROGRESS_HEARTBEAT_SECONDS: int = 10
    ARCHIVE_SYNC_PROGRESS_COMMIT_EVERY_ITEMS: int = 16
